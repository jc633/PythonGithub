...
import os
os.chdir(r'C:\Users\Administrator\Desktop')  # 改工作目录为桌面
...
def getData(html, num_url):  # html:网页源码 ，num_url:页面链接
    ...
    for r in soup.find_all('div', class_='star'):
        ...
        R_count.append(rs[7].text.split('人')[0])  # 得到评论人数
